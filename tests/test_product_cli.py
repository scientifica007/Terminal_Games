...
class ProductVersionTests(unittest.TestCase):
    def test_development_version_targets_v1_2_0(self) -> None:
        self.assertEqual(terminal_games.__version__, "1.2.0.dev0")
...
class ProductCliTests(unittest.TestCase):
    def test_version_flag_prints_product_version_without_launching_games(self) -> None:
        ...
        self.assertEqual(output.getvalue().strip(), "terminal-games 1.2.0.dev0")
